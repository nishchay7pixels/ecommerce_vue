...
export default {
  ...
  methods: {
    goToHomepage() {
      ...
      //Note - when using route 'to' or 'push' to redirect to homepage I am unable to scroll on home page
      //hence using window.location.replace() instead
