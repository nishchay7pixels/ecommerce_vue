      ...
      >
        <div class="product-grid6">
          <div class="product-image6">
            <a href="#">
              <img class="pic-1" :src="product.data.image" />
            </a>
          </div>
          <div class="product-content">
            <label class="title">{{ product.data.name }}</label>
            <div class="price">
              ${{ product.data.price }}
              <span>${{ product.data.raw_price }}</span>
            </div>
          </div>
          <ul class="social">
            <li>
              <a href="" data-tip="View"><i class="fa fa-search"></i></a>
            </li>
            <!-- <li>
  ...
  methods: {
    getProducts() {
      db.collection("Products")
        .where(this.searchField,"==",this.value)
        .limit(4)
        .get()
        .then((querySnapshot) => {
